...
// 產生時間：2026-08-29T09:06:00.212Z
// ============================================
import { describe, it, expect } from 'vitest';
import { mount } from '@vue/test-utils';
import PuzzleCardFooter from '../../../../app/components/puzzle/PuzzleCardFooter.vue';
...
function mountComponent(overrideProps = {}) {
  return mount(PuzzleCardFooter, {
    props: { ...defaultProps, ...overrideProps },
  });
}

describe('PuzzleCardFooter.vue', () => {
  // ===== 基本掛載 =====
  it('應該能正常掛載', () => {
